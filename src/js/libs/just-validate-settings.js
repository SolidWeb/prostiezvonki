...
export function initJustValidateSettings() {
  const forms = document.querySelectorAll('.form, .lead');
  ...
  forms.forEach((form) => {
    ...
    const emailFields = form.querySelectorAll('.input-email[required], .lead__input[required]');
    ...
    validator.onSuccess((event) => {
      ...
      const successDialog = document.querySelector('.dialog-container[data-name="success"]');
      successDialog && openDialog('success');
